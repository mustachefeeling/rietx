...
class GroupFit:
    ...
    #: of the three conditions :func:`~anatase.indexing.pick._not_separable`
...
def fit_group_at(det: Detection, group: PeakGroup, instrument: Instrument,
    ...
    residual's proposal, so :func:`~anatase.indexing.pick._not_separable` never
...
def fit_group(det: Detection, group: PeakGroup, instrument: Instrument, *,
    ...
    :data:`~anatase.schemas.indexing.PEAK_KEEP_COMPONENT_MIN_DELTA_BIC` on

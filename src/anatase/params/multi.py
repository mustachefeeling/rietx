...
A joint refinement fits one **shared** :class:`~anatase.schemas.structure.Structure`
against several patterns, each measured on its **own**
:class:`~anatase.schemas.instrument.Instrument` (different wavelength, geometry,
...
:func:`~anatase.optimize.least_squares.run_multi_least_squares` scatters each

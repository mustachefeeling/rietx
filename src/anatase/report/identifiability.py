...
fit screened onto :class:`~anatase.schemas.results.Identifiability` (the
...
:class:`~anatase.report.schemas.IdentifiabilityEvidence` and
:class:`~anatase.report.schemas.ExchangeFinding` docstrings; this module is
...
:mod:`~anatase.report.schemas`, the spike table in the WP-1056 handover):

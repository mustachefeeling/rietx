"""What this build of anatase can do, as data (WP-1007).
...
table, and the meta-test checks every name in it against ``anatase.__all__`` —
...
def capabilities() -> Capabilities:
    ...
    # Local, and not for cost: ``anatase.gui`` imports the session, which imports
...
#: ``anatase.__all__`` — because the two halves of a derived predicate (the name

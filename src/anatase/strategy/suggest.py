...
(:func:`~anatase.optimize.statistics.one_parameter_gains`); both gates run
through :func:`~anatase.optimize.statistics.block_projection_r2` — absorption
...
compiling the probe model are :meth:`anatase.refine.Refinement.suggest`'s
...
def _matched_action_kind(path: str, actions: Sequence) -> str | None:
    ...
    The two-way fnmatch mirrors :func:`anatase.report.apply_strategy_veto`:

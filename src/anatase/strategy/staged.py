...
class GuardReport:
    ...
    :class:`~anatase.schemas.results.Identifiability` carries all of them onto
    ...
    :mod:`~anatase.schemas.results` rows verbatim; no guard thresholds them,
    the report does.
    """

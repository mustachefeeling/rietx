...
* **the orbit** — every symmetry image of every asymmetric-unit atom, from
  :func:`~anatase.crystallography.symmetry.expand_orbit`, *with* the rotation
...
routed through :func:`~anatase.crystallography.adp.isotropic_u6` because it is
...
def element_symbol(species: str) -> str:
    ...
    Same grammar :func:`~anatase.crystallography.scattering.normalize_species`

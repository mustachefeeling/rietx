...
fit screened onto :class:`~pxrdref.schemas.results.Identifiability` (the
...
:class:`~pxrdref.report.schemas.IdentifiabilityEvidence` and
:class:`~pxrdref.report.schemas.ExchangeFinding` docstrings; this module is
...
:mod:`~pxrdref.report.schemas`, the spike table in the WP-1056 handover):

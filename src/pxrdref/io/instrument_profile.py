...
def save_instrument_profile(instrument: Instrument, path: str | Path) -> None:
    ...
    The background and the specimen displacement/transparency are stripped:
    they describe one measurement, not the goniometer.
    """
...
def load_instrument_profile(path: str | Path) -> Instrument:
    ...
    transparency are 0 and refinable per the sample plan.
    """

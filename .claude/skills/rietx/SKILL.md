...
| §7j — a magnetic or distortion-mode `Diagnostic` fired: a magCIF/TOPAS/FullProf reader's own moment codes, a magnetic-width or moment-pair reading, a k-vector tie, a distortion-mode support code, or an unnamed child group | [`references/magnetic.md`](references/magnetic.md) | `results` |

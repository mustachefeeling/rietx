...
| §7j — a magnetic `Diagnostic` fired, or `FitReport.satellites` ranked a k, or you were handed a magnetic structure (magCIF, TOPAS moments, a `.pcr` magnetic phase) | [`references/magnetic.md`](references/magnetic.md) | `results`, `files` |

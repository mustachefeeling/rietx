...
- `rx.StageResult` — One stage's outcome.
  Fields: `name: str`, `status: Literal['converged', 'max_iter', 'diverged']`, `n_iterations: int`, `cost_initial: float`, `cost_final: float`, `freed: list[str] = []`, `ftol: float | None = None`, `n_constraint_truncations: int = 0`, `n_degenerate_cell_probes: int = 0`, `held: list[str] = []`, `held_reach: dict[str, list[str]] = {}`, `released: list[str] = []`, `blocked_by_hold: list[str] = []`

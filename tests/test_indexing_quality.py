...
from pxrdref.indexing.diagnostics import quality_diagnostics
...
from pxrdref.report.schemas import SEPARABILITY_MIN_SS_RATIO
...
def test_gate_on_a_picked_lab_pattern():
    ...
    from pxrdref import pick_peaks

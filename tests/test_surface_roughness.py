...
from rietx.model.corrections import (
    surface_roughness_pitschke,
    surface_roughness_suortti,
)
from rietx.params.vector import ParameterTable
from rietx.schemas import Geometry, RoughnessPitschke, RoughnessSuortti
...
def test_every_analytic_column_matches_fd_with_roughness_on(block):
    ...
    from rietx.schemas import PreferredOrientation
...
def _absorption_at(two_theta_min: float):
    ...
    from rietx.optimize.statistics import roughness_absorption
...
def test_roughness_is_identifiable_when_the_fit_reaches_low_angle():
    ...
    from rietx.strategy.staged import ROUGHNESS_ABSORPTION_GUARD
...
def test_the_partial_projection_is_what_makes_the_guard_work():
    ...
    """
    from rietx.optimize.statistics import block_projection_r2
...
def test_unconstrained_roughness_is_flagged_rather_than_reported_as_measured():
    ...
    from rietx.refine import ROUGHNESS_MIN_DEPRESSION, _roughness_regime_diagnostics
...
def test_pitschke_outside_its_regime_is_flagged_not_clamped():
    ...
    from rietx.refine import _roughness_regime_diagnostics
...
def test_background_absorption_numbers_are_unchanged_by_the_refactor():
    ...
    from rietx.optimize.statistics import background_absorption, block_projection_r2

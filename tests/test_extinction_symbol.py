...
from pxrdref import determine_extinction_symbol
from pxrdref.indexing.extinction import (
    DECISIVE_DELTA_BIC,
    absence_classes,
    compatible_groups,
    extinction_symbol,
...
from pxrdref.indexing.fom import lattice_group
...
def test_the_answer_is_a_class_and_a_class_is_a_list(mono_screen):
    ...
    """
    from pxrdref.schemas.indexing import ExtinctionScreen
...
def test_fap_would_be_refuted_by_the_background_null_model(fap_screen):
    ...
    """
    from pxrdref.indexing.extinction import _fit_class
    from pxrdref.indexing.peaks import predicted_fwhm
    from pxrdref.indexing.workflow import structure_from_candidate, validation_plan

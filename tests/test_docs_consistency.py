...
SIZE_CAPS: dict[str, int | None] = {
    ...
    # 831 -> 837 (2026-09-24): six rows, 1453-1458, filed by the review of an
    # agent session on a private in-situ series, across four existing
    # sections.  No prose: the evidence stays in the WP files.  Landed 836,
    # +1 headroom.
    "docs/ROADMAP.md": 837,

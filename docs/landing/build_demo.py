...
def build(bundle: Path, k: int = 1) -> dict:
    ...
    return OrderedDict(
        ...
        credit="Contributed by Michael W. Gaultois. Work performed with Jamie Capel, Martin C. Chan, Stuart Scott, Felix Donat, and Prof. Clare Grey at the Department of Chemistry, University of Cambridge.",

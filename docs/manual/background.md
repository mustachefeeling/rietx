...
*Source:* `pxrdref.background.models`
...
*Source:* `pxrdref.background.estimators`
...
*Source:* `pxrdref.background.select`
...
*Source:* `pxrdref.optimize.statistics.background_absorption`

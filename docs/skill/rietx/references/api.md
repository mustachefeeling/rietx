...
- `rx.Structure.from_cif(path: str, *, phase_name: str | None = None, aniso: bool = False, moment_ions: dict[str, str] | None = None, moment_g: dict[str, float] | None = None, diagnostics: list | None = None) -> Structure` — Read a CIF, or a **magCIF**, into a `Structure`.
...
- `rx.Stage` — One turn-on group of a staged plan — a declaration, not a result.
  Fields: `name: str`, `turn_on: list[str]`, `max_iter: int = 100`, `ftol: float | None = None`, `lebail_cycles: int = 3`, `seed: float = 0.0`, `strain_seed: float = 0.0`, `distortion_seed: float = 0.0`, `restraint_weight_scale: float = 1.0`, `window_slack_deg: float | None = None`

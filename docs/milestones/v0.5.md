...
[../DESIGN.md](../DESIGN.md); the consumer-facing protocol these findings feed: the [agent
skill](../skill/rietx/SKILL.md), called `AGENT_PROTOCOL.md` when this was written.
...
([AGENT_PROTOCOL §8.12](../skill/rietx/SKILL.md)).
...
[AGENT_PROTOCOL.md](../skill/rietx/SKILL.md) and `rietx compare`, the
...
[AGENT_PROTOCOL §8.1](../skill/rietx/SKILL.md) leads with it.
...
- **Two new deliverables.** [AGENT_PROTOCOL.md](../skill/rietx/SKILL.md) — the
  consumer-facing protocol for driving this package from an agent — and
  `rietx compare`, a browser UI comparing refinement settings on the bundled

...
reported as.** The plan named four candidates for "the panel drag lags" and
deliberately picked none; the profile indicted one and exonerated three, and
reading the source had ranked them differently.

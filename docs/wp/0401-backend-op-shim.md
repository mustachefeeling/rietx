...
- The seams are already half-built: `src/rietx/backend/` exists (empty, the
  home for `api.py`), and a `backend: str = "numpy"` kwarg is threaded through
  [`refine.py`](../../src/rietx/refine.py) (~line 58),
  [`multi.py`](../../src/rietx/multi.py) (~line 73) and
  [`schemas/common.py`](../../src/rietx/schemas/common.py) (~line 109), each

...
Depends on: [1062](1062-rename-to-anatase.md) (blocked [1003](1003-api-freeze-pypi.md))
...
sample name rather than a program. [1062](1062-rename-to-anatase.md) accepted
...
- **This file** and **[1062](1062-rename-to-anatase.md)**: both document a
...
- The prior rename, its measured gotchas and the Phase-1 design this one
  inherits: [1062](1062-rename-to-anatase.md).

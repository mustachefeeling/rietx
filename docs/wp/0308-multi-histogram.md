...
[`refine.py`](../../src/rietx/refine.py) and
...
[`background/models.py`](../../src/rietx/background/models.py) and the
statistics handling in
[`optimize/statistics.py`](../../src/rietx/optimize/statistics.py) first,

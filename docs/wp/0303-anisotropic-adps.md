...
- Schema: an optional aniso block on the atom in
  [`schemas/structure.py`](../../src/rietx/schemas/structure.py). Keep
...
- Forward model: the Debye-Waller factor in
  [`crystallography/structure_factor.py`](../../src/rietx/crystallography/structure_factor.py)
...
[`optimize/statistics.py`](../../src/rietx/optimize/statistics.py) — a

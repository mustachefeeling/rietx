...
| **rietx today** | **30–150 s per real dataset** |
...
- [x] `rietx index --ceiling` and `--total-budget`; `SearchSpecSpec` gains the
...
`rietx index tests/data/qarr/corundum.prn --wavelength 1.5405929 --ceiling`

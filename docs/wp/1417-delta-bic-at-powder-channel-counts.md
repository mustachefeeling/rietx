...
- [ ] Measure both effective-N estimators on every acceptance fixture and on
...
- [ ] Manual Part 2's model-comparison section states the premise ΔBIC needs
      and where the package measures its violation.
- [ ] Tests: a synthetic fit at 50 000 correlated points where the added

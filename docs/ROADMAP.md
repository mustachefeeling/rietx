...
**v1.2 — the GUI for a crystallographer** ([record](milestones/v1.2.md)); the maintainer's use notes triaged into 17 WPs (1201-1217) plus [1017](wp/1017-gui-manual-onboarding.md), the manual, last. Three shipped 2026-08-25: [1201](wp/1201-gui-house-style.md), the token layer and nine control registers `gui/CLAUDE.md` § House style names and `lib/style.test.ts` guards; [1204](wp/1204-developer-mode-example-projects.md), which made the empty state openable; and [1202](wp/1202-help-corpus.md), `src/rietx/help.py` — 92 entries covering every parameter family, peak flag, stage field, reader option, preset field and plan, each arm crossed against its live vocabulary **both ways**, with `docs/manual/using/glossary.md` generated from it. **Next: [1203](wp/1203-help-popover.md)**, which renders that corpus against the `.help` register 1201 declared; its `### Inherited` carries what 1202 measured, including why a row holds a family *key* and not the entry. After that the § v1.2 table's order: the wizard (1205-1207, and 1205 carries an `### Inherited` note from 1204), Plan (1208), Peaks and the plot (1209-1213), Model (1214-1216), History (1217).

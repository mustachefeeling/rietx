...
| [1457](wp/1457-a-topas-tchz-profile-reads-in.md) | A TOPAS TCHZ profile reads in | ⬜ | P3 | — (1433 soft) |
...
| [1455](wp/1455-a-spline-penalty-in-the-patterns-units.md) | A spline penalty in the pattern's units | ⬜ | P2 | — |
| [1456](wp/1456-one-flat-direction-one-finding.md) | One flat direction, one finding | ⬜ | P3 | — (1455 soft) |
...
| [1453](wp/1453-a-series-whose-phases-come-and-go.md) | A series whose phases come and go | ⬜ | P2 | — (1420 soft) |
| [1454](wp/1454-both-directions-name-the-lower-cost.md) | Both directions name the lower cost | ⬜ | P3 | — (1453 soft) |
...
| [1458](wp/1458-an-editable-install-stamps-what-it-runs.md) | An editable install stamps what it runs | ⬜ | P3 | — |

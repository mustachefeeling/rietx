...
**v0.3** — WP-0301 through WP-0307 and the acceptance WP-0310 are done
...
Layer-1 axis diagnostic on `FitReport.texture`; the v0.3 acceptance is
measured and recorded in [milestones/v0.3.md](milestones/v0.3.md)). Next:
[0308](wp/0308-multi-histogram.md) or [0309](wp/0309-exporters.md) — the last
two open WPs; the milestone row flips to ✅ when they land.

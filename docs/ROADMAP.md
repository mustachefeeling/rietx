...
**Next: v1.3 — agents and programs** (1301-1307, filed 2026-08-28), the agent surface refactored against two measured runs rather than intuition; it opens with the version bump to `1.3.0.dev0`, and [1301](wp/1301-hold-unsupported-phase.md) is first. Free-standing peaks (1101-1103) stay at **v1.4**. `pyproject.version` is `1.2.0` — the last shipped, until v1.3 opens.
...
| v1.3 | Agents and programs: the termination view, the hold, the skill, the interchange format | ⬜ **next** (opens with the version bump) | — |

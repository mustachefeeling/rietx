...
**v1.2 — the GUI for a crystallographer** ([record](milestones/v1.2.md)); the maintainer's use notes triaged into 17 WPs (1201-1217) plus [1017](wp/1017-gui-manual-onboarding.md), the manual, last. Two shipped 2026-08-25: [1201](wp/1201-gui-house-style.md), one token layer and nine control registers in `gui/src/app.css`, with `gui/CLAUDE.md` § House style as the vocabulary every later panel WP writes markup against and `lib/style.test.ts` as the guard; and [1204](wp/1204-developer-mode-example-projects.md), which made the empty state openable — `rietx gui --scratch` for a project you do not want changed, and three example projects in the wheel, each one a `viz/compare.py` standard so no protocol is restated. **Next: [1202](wp/1202-help-corpus.md)/[1203](wp/1203-help-popover.md)**, which attach the popover to the `.help` register 1201 declared. After that the § v1.2 table's order: the wizard (1205-1207, and 1205 carries an `### Inherited` note from 1204), Plan (1208), Peaks and the plot (1209-1213), Model (1214-1216), History (1217).
